...
import skillImg_1 from "@/assets/img/about/1sm.webp"
      ...
      <div className="skill-area bg-relative pd-bottom-100">
         <div className="container">
            <div className="row">
               ...
               <div className="col-lg-6 px-lg-5 col-md-9 mt-5 mt-lg-0">
                  <div className="about-mask-bg-wrap about-mask-bg-wrap-1 mb-4 mb-lg-0">
                     <Image className="shape-image-sm top_image_bounce" src={skillImg_1} alt="img" />
                     <Image className="shape-image" src={skillImg_2} alt="img" />
                     <div className="thumb">

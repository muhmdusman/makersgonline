...
const Progress = ({
   ...
   return (
      <>
         <div ref={progressRef} className="progress-bg" data-pct={displayedProgress}>
            <div id="progress" className="progress-rate" data-value="75" style={{ width: `${displayedProgress}%` }}>
            </div>
            <div className="progress-count-wrap">
               <span className="progress-count counting" data-count="75">{displayedProgress}</span>
